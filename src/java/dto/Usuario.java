...
public class Usuario {
    ...
    //Metodo para  Modificar contra de un usuario
    public void mod_pass(String new_clave,int id)throws Exception
    {
        Respuesta resp = new Respuesta();
        DB dbase = new DB("itla2","admini3lwux2","aLXsCK8L2Pmy");
        String sql="UPDATE   public.t_usuarios SET  f_clave = "+new_clave+" WHERE   f_id = "+id+";";
